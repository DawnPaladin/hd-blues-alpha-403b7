...
const Flexbox = (props) => {
    ...
    const className = classNames('flex', 'flex-item', mapMaxWidthStyles(styles?.self?.width), mapFlexDirection(styles?.self?.flexDirection), mapJustifyContent(styles?.self?.justifyContent), mapAlignItems(styles?.self?.alignItems), 'm-auto' /* margin: auto */);
    return (
