...
const Flexbox = (props) => {
    ...
    const className = classNames('flex', mapMaxWidthStyles(styles?.self?.width), mapFlexDirection(styles?.self?.flexDirection), mapJustifyContent(styles?.self?.justify-content), 'm-auto' /* margin: auto */);
    return (
